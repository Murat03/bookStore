		...
		public static void AddCustomMediaTypes(this IServiceCollection services)
		{
			services.Configure<MvcOptions>(config =>
			{
				...
				if(systemTextJsonOutputFormatter is not null)
				{
					...
					systemTextJsonOutputFormatter.SupportedMediaTypes
					.Add("application/vnd.mstore.apiroot+json");
				}
				...
				if(xmlOutputFormatter is not null)
				{
					...
					xmlOutputFormatter.SupportedMediaTypes
					.Add("application/vnd.mstore.apiroot+xml");
				}
			});
		}
		...
		public static void ConfigureSwagger(this IServiceCollection services)
		{
			services.AddSwaggerGen(s =>
			{
				s.SwaggerDoc("v1", new OpenApiInfo
				{
					...
					TermsOfService = new Uri("https://github.com/Murat03/bookStore"),
					Contact = new OpenApiContact
					{
						Name = "Murat İPEK",
						Email = "muratipekk03@gmail.com",
						Url = new Uri("https://www.linkedin.com/in/muratipek/")
					}
				});
